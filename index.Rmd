...
ggplotly(barplot1)
```
> A barplot to show the average scores for multiple variables between 0 and 1.This graph gives us a quick overview of the differences and similarities between the two genres according to spotify.
