...
```{r echo=FALSE}
solsbury_hill <-
  get_tidy_audio_analysis("6vZZtivPrtpggT5SSXsYTy?si=abd73a0c0d8549ee") |>
...
solsbury_hill |>
  compmus_self_similarity(pitches, "chebyshev") |> 
  ggplot(
    aes(
...
***
Hallo zeg nuttige informatie over mijn matrix.

### Self-similarity matrix based on timbre
...
***
The first matrix is based on the pitch. Blub blub blub
The second matrix is based on the pitch.
